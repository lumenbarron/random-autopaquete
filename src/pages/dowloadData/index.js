...
export default function ExportReactCSV({ data }) {
    ...
    const headers = [
        ...
        { label: 'Calle Origen', key: 'sender_addresses.street_name' },
        { label: 'Numero Origen', key: 'sender_addresses.street_number' },
        ...
        { label: 'Calle Destino', key: 'receiver_addresses.street_name' },
        { label: 'Numero Destino', key: 'receiver_addresses.street_number' },
